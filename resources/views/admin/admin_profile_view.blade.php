...
<div class="container-full">
		...
		<img class="rounded-circle" src="{{(!empty($admindata->profile_photo_path)) ? url('upload/admin_images/'.$admindata->profile_photo_path):url('upload/noimage.png')}}" alt="User Avatar">
