						...
						<div class="col-12">
							...
							<div class="row">
								...
								<div class="col-md-6">
									...
									<img src="{{(!empty($editdata->profile_photo_path)) ? url('upload/admin_images/'.$editdata->profile_photo_path):url('upload/noimage.png')}}" style="width: 100px; height: 100px;" id="showImage">
